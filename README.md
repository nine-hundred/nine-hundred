# 김창민 (Changmin Kim)
## 👋 Backend Developer
대규모 트래픽 환경에서 서비스 연속성을 지켜온 백엔드 개발자입니다.</br>
복잡한 시스템을 효율적으로 설계하는 과정에서 성취감을 느끼며, 테스트에 진심입니다.
...
## 💻 Technical Expertise
- **서버 개발 & API**: Go/Python 기반 백엔드 서버 설계 및 개발, REST/GraphQL API 구현
- **AI/LLM 시스템 통합**: 다중 LLM API(Claude, Grok...) 연동, Prompt Caching으로 API 비용 절감
- **대용량 메시징 시스템**: SQS/Redis를 활용한 메시지 큐 관리, 월 3억 건의 이벤트 분산 처리 시스템 구축
- **모니터링 & 로깅**: Prometheus, Grafana 기반 통합 모니터링 시스템 운영, CloudWatch 로그 수집 파이프라인 구축
- **CI/CD & 개발 생산성**: GitHub Actions 기반 배포 자동화, Claude API 활용 자동 PR 리뷰 시스템 구축
- **테스트 자동화**: TestContainer/LocalStack 기반 통합 테스트 환경 구축
<!--
**nine-hundred/nine-hundred** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
-->
[![Solved.ac
프로필](http://mazassumnida.wtf/api/generate_badge?boj=ninehundred)](https://www.acmicpc.net/user/ninehundred)
